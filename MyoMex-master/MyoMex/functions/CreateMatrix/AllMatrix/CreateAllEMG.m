...
%E_extension50 = [DE_TestA50(start:ending,:); FE_TestA50(start:ending,:); SE_TestA50(start:ending,:)];
...
%E_flexion50 = [DF_TestA50(start:ending,:); FF_TestA50(start:ending,:); SF_TestA50(start:ending,:)];
...
%E_ulnar50 = [DU_TestA50(start:ending,:); FU_TestA50(start:ending,:); SU_TestA50(start:ending,:)];
...
%E_radial50 = [DR_TestA50(start:ending,:); FR_TestA50(start:ending,:); SR_TestA50(start:ending,:)];
