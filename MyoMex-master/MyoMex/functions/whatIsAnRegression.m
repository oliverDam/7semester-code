function [output] = whatIsAnRegression(rightData, wrongData1, wrongData2, wrongData3, movement)
...
inputData(1:5400,1:8) = rightData;

inputData(5401:10800,1:8) = wrongData1;
inputData(10801:16200,1:8) = wrongData2;
inputData(16201:21600,1:8) = wrongData3;
