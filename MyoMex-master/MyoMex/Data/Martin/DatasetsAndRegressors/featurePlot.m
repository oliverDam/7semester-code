...
subplot(2,2,1)
scatter(nedExMov,nedEx,'g')
hold on
scatter(opExMov,opEx,'r')
scatter(sideExMov,sideEx,'c')
xlabel('Normalized EMG intensity')
ylabel('Feature intensity')
legend('Down','Up','Side')

subplot(2,2,2)
scatter(nedFlexMov,nedFlex,'g')
hold on
scatter(opFlexMov,opFlex,'r')
scatter(sideFlexMov,sideFlex,'c')
xlabel('Normalized EMG intensity')
ylabel('Feature intensity')
legend('Down','Up','Side')

subplot(2,2,3)
scatter(nedRadMov,nedRad,'g')
hold on
scatter(opRadMov,opRad,'r')
scatter(sideRadMov,sideRad,'c')
xlabel('Normalized EMG intensity')
ylabel('Feature intensity')
legend('Down','Up','Side')

subplot(2,2,4)
scatter(nedUlMov,nedUl,'g')
hold on
scatter(opUlMov,opUl,'r')
scatter(sideUlMov,sideUl,'c')
xlabel('Normalized EMG intensity')
ylabel('Feature intensity')
legend('Down','Up','Side')